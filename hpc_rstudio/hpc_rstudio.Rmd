...
Firefox allows a simple interface to route traffic through the proxy. macOS user can also set up a system-wide SOCKS5 proxy System Preferences->Network. Users will enter localhost, but the port number for the proxy (3) will be the port specified when invoking the script.
